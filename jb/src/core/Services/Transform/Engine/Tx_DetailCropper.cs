...
public class Tx_DetailCropper : IImageTransformation
{
    ...
    /// <summary>
    /// Routes to the branch matching the bbox's edge-intersection count/pattern and returns the
    /// resulting JPEG bytes, the final square canvas side, whether <see cref="Tx_util_BgStretch"/>
    /// was used to extend the canvas, and a diagnostic warning describing which branch fired.
    /// </summary>
