...
/// <summary> The Classify chain's parameter bundle: the ClassifyConfig.json sections owned by this project,
...
public sealed class ClassifyParameters {
    ...
    /// <summary> Loads every ClassifyConfig.json section this bundle owns, then composes them. A missing file, a
    /// misspelled key, or an out-of-range value throws here — so calling this at host startup fails the
    /// process loud rather than failing the first image mid-job. </summary>
