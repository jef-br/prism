...
- [ ] `product-coverage-ratio` is a box-area approximation. Milestone: yolov8n-seg (or similar) provides pixel masks for true coverage. Same milestone retires the color-distance fallback entirely.
