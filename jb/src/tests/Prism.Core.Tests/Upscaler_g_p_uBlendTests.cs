...
/// </summary>
public class Upscaler_g_p_uBlendTests
{
    ...
    {
        float weight = Upscaler_g_p_u.RampFromEdge(distFromEdge, OverlapOut, DiscardOut);
    ...
    public void AxisWeight_BothEdgesOutward_AlwaysReturnsOne()
    {
        ...
        {
            float weight = Upscaler_g_p_u.AxisWeight(pos, 50, OverlapOut, DiscardOut, startOutward: true, endOutward: true);
    ...
    {
        float weight = Upscaler_g_p_u.AxisWeight(0, 50, OverlapOut, DiscardOut, startOutward: false, endOutward: true);
    ...
    public void AxisWeight_DeepInterior_AwayFromBothSeamFacingEdges_ReturnsOne()
    {
        ...
        float weight = Upscaler_g_p_u.AxisWeight(25, 50, OverlapOut, DiscardOut, startOutward: false, endOutward: false);
    ...
    public void AxisWeight_NeverNegative()
    {
        for (int pos = 0; pos < 50; pos++)
        {
            float weight = Upscaler_g_p_u.AxisWeight(pos, 50, OverlapOut, DiscardOut, startOutward: false, endOutward: false);
