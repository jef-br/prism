...
/// T-5090 rework: SelectedPhenotype no longer gates routing at all — fixtures still set it for
/// realism, but routing depends only on bbox presence and edge intersects.
/// </summary>
public class SubjectGeometryRoutingTests {
    ...
    [Fact]
    public void ConfidentSubject_WithIntersect_RoutesToDetailCropper() {
        ImageRecord_LAMBDA lambda = new() {
            InitialFullName = "img.jpg",
            Width = 1000,
            Height = 1000,
