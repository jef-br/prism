...
// ---------------------------------------------------------------------------
// Seed data — reflects PRISM's real five-table config architecture.
// Everything here is editable in the tool; this is just a starting point.
// ---------------------------------------------------------------------------
...
const seedFeatures = [{
    ...
    },
    {
        ...
        type: "enum, scored",
        description: "Visual plausibility signal only — NOT the routing key. E.g. supports/forbids based on plausibility, like 'unlikely to be pregnant if gender=male'.",
        params: [{
            key: "confidence-bar",
            value: "0.45"
        }]
      ...
      `
...

                    {
                        ...
                        tab === "features" && ( <
                            ...
                            subtitle = "One feature = one analyzer, no overlap. Product type and brand deliberately live in Routing, not here — they're keys, not visual traits."
                            right = {
                                < button onClick = {
                                    addFeature
                                }
...

                                {
...

                                    {
                                        ...
                                        tab === "routing" && ( <
                                            ...
                                            subtitle = "Resolves (brand, product type) → profile, first-hit precedence. Brand and product type are routing keys — sourced from the Excel model, not phenotype features."
                                            right = {
                                                < button onClick = {
                                                    addRoutingRule
                                                }
                                            ...
                                            div style = {
                                                ...
                                                note = "Curated list — swap for the official company product-type list at a later stage." / >
                                                    <
                                            ...
                                            note && < p style = {
                                                ...
                                                div style = {
                                                    ...
                                                    items.map((it) => ( <
                                                        ...
                                                        small > {
                                                            it
                                                        } <span onClick = {() => onRemove(it)}style = {{cursor: "pointer",marginLeft: 2,color: "var(--ink-faint)"}} > < X size = {10}/></span >
                                                        <
                                                        /Chip>
                                                    ))
                                                } <
