...
***Both behaviors (route-1 and route-2) should be implemented in `Tx_DetailCropper.cs` *** If that is the case, Route-1 and Route-2 are identical to `Tx_DetailCropper.cs`. 