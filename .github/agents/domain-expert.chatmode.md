...
4. `AGENT-TICKETS.md` — understand current work context so your answers are relevant
...
**Image Taxonomy**
HERO / DETAIL / PACKSHOT and other image roles, orientation, shot type, human detection, and how these map to ecommerce taxonomy conventions (GS1, Amazon variant codes).
