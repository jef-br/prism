...
##### Changed
- None. No repo substance change since the 24/09 brief. Working tree clean; the only commit since the 24/09 brief (`0ae99bb`) is this brief. Last non-brief commit remains `fef1ebe`/`43f2c58` (PR #32, architecture overview + nine drawio diagrams, 2026-09-02). All seven `jbtodo.md` untouched since 2026-08-12; board + `AGENT-TICKETS-ARCHIVE.md` last touched 2026-08-26 (`06aa545`), `AGENTFEEDBACK.md` 2026-08-12, `jb/docs/` 2026-09-02. The three Todo updates below are the same standing carry-overs — still accurate, still unactioned by Jef — not fresh finds; there is no new data to mine this pass.
