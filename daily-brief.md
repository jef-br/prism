...
##### Changed
- No repo substance change since the 20/09 brief (`d75936c`). Only delta is this 21/09 brief itself; 20/09 and 21/09 are now consecutive (the 19/09 gap noted earlier stands). Last non-brief commit is still `fef1ebe`/`43f2c58` (PR #32, architecture overview + nine drawio diagrams, 2026-09-02); every commit since is a daily-brief. Working tree clean; all seven `jbtodo.md` untouched since 2026-08-12; board + `AGENT-TICKETS-ARCHIVE.md` last touched 2026-08-26 (T-4942 close), `AGENTFEEDBACK.md` 2026-08-12, `jb/docs/` 2026-09-02 — all unchanged. The three Todo updates below are unchanged carry-overs, still unactioned by Jef, so they remain standing recommendations rather than new finds.
