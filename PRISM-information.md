...
- **Batch cap**: 10000 images (`Input.Images.amount.max`). Max 250 MB/image file. Limits in CFG.
...
**CLIP SHA-256** (`jb/src/core/Services/Matching/Classify/ONNX/clip-vit-b32-uint8/model_uint8.onnx`):
